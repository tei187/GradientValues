...
Class Generator {
     ...
     * Class constructor.
     *
     * @param array|string|null $values If array, each value has to be RGB(a) (hex `"rgba"`, `"rrggbbaa"` or string `"r,g,b,a"`). If string, has to be a name of predefined gradient equating to key in $default property.
     */
    ...
    /**
     * Returns names of default preset gradients.
     *
     * @return array Array with keys of $this->default as values.
     */
    public function returnDefaultGradients() : array {
